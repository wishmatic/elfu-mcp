...
func TestServeNotFound(t *testing.T) {
	tests := []struct {
		...
		{name: "missing key", target: "https://elfu.example.com/i/2026-09/missing.png"},
		{name: "traversal", target: "https://elfu.example.com/i/../../etc/passwd.png"},
		{name: "encoded traversal", target: "https://elfu.example.com/i/%2e%2e/%2e%2e/etc/passwd.png"},
		{name: "unknown extension", target: "https://elfu.example.com/i/2026-09/x.gif"},
		{name: "other namespace", target: "https://elfu.example.com/a/avatars/x.png"},
		{name: "no extension", target: "https://elfu.example.com/i/2026-09/x"},
	}
...
func TestServeDeletedFile(t *testing.T) {
	...
	key := strings.TrimPrefix(url, "https://elfu.example.com/")
